  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow">
        <h1 className="text-2xl font-bold text-center mb-4">Keno Analyzer</h1>
        ...
        {results && (
          <div className="mt-4 space-y-4">
            <div>
              <h2 className="font-semibold mb-2">Most Frequent Numbers:</h2>
            ...
            <div>
              <h2 className="font-semibold mb-2">Least Frequent Numbers:</h2>
              <div className="grid grid-cols-2 gap-2">
            ...
            <div className="mt-4">
              <h2 className="font-semibold mb-2">Recent Draws:</h2>
